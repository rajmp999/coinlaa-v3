...
export function HeroCarousel() {
  ...
  const handleCTAClick = (featureId: string) => {
    setIsAutoPlaying(false)
    
    switch(featureId) {
      case 'tools':
        window.open('https://app.coinlaa.com/ai-tool/', '_blank')
        break
      case 'agents':
        window.open('https://app.coinlaa.com/crypto-agents/', '_blank')
        break
      case 'community':
      case 'events':
      case 'academy':
      case 'news':
        window.open('https://app.coinlaa.com/register/', '_blank')
        break
      default:
        window.open('https://app.coinlaa.com/register/', '_blank')
    }
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <Button 
              ...
              onClick={() => handleCTAClick(currentFeature.id)}
            >
              {currentFeature.cta}
